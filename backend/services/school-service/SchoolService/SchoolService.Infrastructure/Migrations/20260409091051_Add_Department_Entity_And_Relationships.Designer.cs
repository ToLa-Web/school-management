...
namespace SchoolService.Infrastructure.Migrations
{
    ...
    [Migration("20260409091051_Add_Department_Entity_And_Relationships")]
    partial class Add_Department_Entity_And_Relationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolService.Domain.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolService.Domain.Entities.TeacherDepartment", b =>
                {
                    b.Property<Guid>("TeacherId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolService.Domain.Entities.Subject", b =>
                {
                    b.HasOne("SchoolService.Domain.Entities.Department", "Department")
                        .WithMany("Subjects")
