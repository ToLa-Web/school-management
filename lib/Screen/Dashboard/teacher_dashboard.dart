...
class _TeacherDashboardState extends State<TeacherDashboard> {
  ...
  // Define the screens for the navigation bar here
  final List<Widget> _screens = [
    const TeacherHomeContent(), // Index 0
    const TeacherCourseScreen(), // Index 1 (Your custom course UI)
    const Center(child: Text("សារ (Messages)")), // Index 2
    const TeacherSettingsScreen(), // Index 3 (Settings UI)
  ];
  @override
...
class TeacherHomeContent extends StatelessWidget {
  ...
  // Helper UI methods moved here to keep code clean
...
//   // Updated Screens List: Replaced index 3 with TeacherSettingsContent
//   final List<Widget> _screens = [
//     const TeacherDashboard(),
//     const TeacherCourseScreen(),
//     const Center(child: Text("សារ (Messages)")),
//     const TeacherSettingsContent(), // Index 3: Now contains the Settings UI
//   ];
...
// // --- 2. HOME SCREEN CONTENT (INDEX 0) ---
// // ... (Keep your existing TeacherHomeContent code here)

// // --- 3. COURSE SCREEN (INDEX 1) ---
// // ... (Keep your existing TeacherCourseScreen code here)

// // --- 4. SETTINGS SCREEN CONTENT (INDEX 3) ---
// class TeacherSettingsContent extends StatelessWidget {
//   const TeacherSettingsContent({super.key});
